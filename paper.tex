...
If there does not exist any path between the exit point $p \in P^i$ (the exit point at frame $i$) and the active site $\qinit^i$ in the same frame, the dynamic tunnel has to start from a different active site (in one of the previous frames).
