...
The relations between the void space of the previous frame and the void space transfered to the new frame are maintained.
It is necessary to support spliting and merging of the detected void space.
...
It is also necessary to remove the nodes outside the protein (these nodes are added in the second phase of the void space detection in order
to find exit points).
...
As the RRT selects the nodes for the expansion only using their distance to the random samples, the edge information is not necessary for their
further expansion.
...
\subsection{Tracking evolution of void space in protein dynamics}

This section presents the main algorithm to track the evolution of the void space in protein dynamics.
